...
export const SetGreeter2 = () => {
  ...
  const greeterAddress = allContracts[chainId][0].contracts.Greeter2.address;
  const greeterABI = allContracts[chainId][0].contracts.Greeter2.abi;
